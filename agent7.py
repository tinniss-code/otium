    ...
    for item in research_items:
        ...
        if item.get('image_url'):
            try:
                ...
                pdf.multi_cell(0, 7, f"Image: {item.get('visual_desc', 'Visual of technology.')}")
        ...
        try:
            response = client.models.generate_content(
                ...
                config=types.GenerateContentConfig(
                    system_instruction="Explain AI to seniors. Output ONLY a JSON array with: title, summary, image_url, visual_desc, relevance.",
